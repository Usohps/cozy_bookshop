    ...
    <>
      <Link to={`/books/${book.id}`}>
        <div>
          ...
          <div
            key={book.id}
            className=" text-white opacity-0 h-full w-full text-center bg-black hover:h-full hover:opacity-[0.7] duration-500 border flex flex-col items-center justify-center absolute top-0 left-0 text-sm "
          >
